...
Sound::Sound(char*  filePath) {
	...
	//Should be "RIFF"
	if (riff_header.chunkID[0]!='R' || riff_header.chunkID[1]!='I' || riff_header.chunkID[2]!='F' || riff_header.chunkID[3]!='F')         endWithError (errors[1]);//Not RIFF
	...
	if (alGetError() != AL_NO_ERROR) endWithError((char*)"Error GenSource");//Error during buffer/source generation
